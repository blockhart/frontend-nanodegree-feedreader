...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
        ...
        /* TODO-4: Write a test that loops through each feed
        ...
        /* TODO-5: Write a test that loops through each feed
    ...
    /* TODO-6: Write a new test suite named "The menu" */
    describe('The menu', function() {
        ...
        it('is hidden by default', function() {
          ...
          */
        describe('and upon click', function(){
            ...
            it('actually moves onscreen', function(done) {
                expect($('body').hasClass('menu-hidden')).toBe(false);
                expect(slideMenu.getBoundingClientRect().x).toBe(onscreenXPosition);
                done();
            });

            it('actually moves back offscreen', function(done) {
                expect($('body').hasClass('menu-hidden')).toBe(true)
                expect(slideMenu.getBoundingClientRect().x).toBe(offscreenXPosition);
                done();
            });
